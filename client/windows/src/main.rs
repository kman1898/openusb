...
#[derive(Parser)]
#[command(name = "openusb-client", about = "OpenUSB Windows client service")]
struct Args {
    /// Override log level
...
async fn main() -> Result<()> {
    ...
    info!("OpenUSB Windows client starting");
    ...
    // On Windows with GUI, the tray icon handles shutdown.
